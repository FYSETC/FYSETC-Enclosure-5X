...
2. Instructions
   - We have updated the installation guide on WIKI,； link:(https://wiki.fysetc.com/docs/FLASHFORGEAD5X-3D-Printer-Enclosure-Kit)

3. FAQ
   - Q: How to install to my 3D printer? A: You can watch  [the assembly manual]([(https://wiki.fysetc.com/docs/FLASHFORGEAD5X-3D-Printer-Enclosure-Kit)).
